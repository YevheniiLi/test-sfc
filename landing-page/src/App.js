    ...
    <div className="landing-section">
      <div className="header-landing">
        ...
        <ul className="landing-group">
          ...
          <li
            className="dropdown"
            onMouseEnter={toogleRecursosDropdown}
            onMouseLeave={toogleRecursosDropdown}
          >
            <span className="dropdown-toggle">Recursos</span>
            <ul
              className={`dropdown-menu ${showRecursosDropdown ? "show" : ""}`}
            >
              <li>
          ...
          <li
            className="dropdown"
            onMouseEnter={toogleCastellanoDropdown}
            onMouseLeave={toogleCastellanoDropdown}
          >
            <span className="dropdown-toggle">Castellano</span>
            <ul
              className={`dropdown-menu ${
                showCastellanoDropdown ? "show" : ""
              }`}
            >
              <li>Español</li>
              <li>Inglés</li>
      ...
      <div className="main-landing-section">
        <div className="landing-text-container">
          ...
          <span className="landing-text">
            Mide el olor y genera datos científicos para mejorar la calidad de
            vida de tu comunidad. ¡Descárgate la App y siente el poder de la
